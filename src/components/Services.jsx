      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-8 rounded-lg shadow-xl">
            ...
            <div className="h-48 bg-gray-200 mt-6 rounded-lg animate-pulse-slow">
              <img src='../assets/image_1.png'/>
            </div>
          </div>
          <div className="p-8 rounded-lg shadow-xl text-center">
            <h3 className="text-2xl font-semibold mb-4">Bespoke 3D Prints</h3>
            <p className="text-gray-600">Capture the essence of your favorite locations with our 3D printing. Each print is a unique, personalized keepsake.</p>
            <div className="h-48 bg-gray-200 mt-6 rounded-lg animate-pulse-slow"></div>
          </div>
          <div className="p-8 rounded-lg shadow-xl text-center">
